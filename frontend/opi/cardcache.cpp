...
Card_cache::Result Card_cache::has_access(Card_cache::Card_id id)
{
    ...
    int user_int_id = -1;
    {
        ...
        RestClient::Response resp = conn.post("/v1/permissions", payload.dump());
        ...
        resp_body = util::json::parse(resp.body);
        ...
        if (!res)
            return Result(Access::Forbidden, user_int_id);
    }
    ...
    return Result(Access::Allowed, user_int_id);
}
    ...
    while (!stop)
    {
        ...
        try
        {
            ...
            util::json resp_body;
            {
                ...
                RestClient::Response resp = conn.get("/v2/permissions/");
